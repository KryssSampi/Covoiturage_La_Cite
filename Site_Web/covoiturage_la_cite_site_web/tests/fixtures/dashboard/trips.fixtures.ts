 ...
 * @description Données de test pour PublishedTripSection (conducteur).
 * ⚠️ DÉVELOPPEMENT UNIQUEMENT — À remplacer par un appel API.
 *
 * TODO: GET /api/driver/{userId}/trips?status=active&limit=10
 *   Retourne les trajets publiés triés par OrganizeTrips (InProgress → à venir → terminés → annulés)
 */
...
export const MOCK_RESERVATIONS: Reservation[] = [
  ...
  },
  {
    ...
    maxPassengers: 2, doneDate: "2026-03-01",
