      ...
      <section className="mx-auto max-w-6xl px-4 pt-16 pb-16">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <article className="group rounded-2xl border border-gray-200 bg-white p-7 shadow-xl hover:bg-gray-50 transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold">{t(tr.keyboardTitleFr, tr.keyboardTitleEn, lang)}</h3>
          ...
          <article className="group rounded-2xl border border-gray-200 bg-white p-7 shadow-xl hover:bg-gray-50 transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold">{t(tr.contrastTitleFr, tr.contrastTitleEn, lang)}</h3>
          ...
          <article className="group rounded-2xl border border-gray-200 bg-white p-7 shadow-xl hover:bg-gray-50 transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold">{t(tr.typographyTitleFr, tr.typographyTitleEn, lang)}</h3>
