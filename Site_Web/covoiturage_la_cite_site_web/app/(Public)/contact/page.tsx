...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pt-20 md:pt-28 pb-12 md:pb-36 text-center">
          <div className="mx-auto mb-6 flex h-16 w-16 md:h-20 md:w-20 items-center justify-center rounded-full bg-[#5E9FE9]/10 border border-[#5E9FE9]/20 shadow-md">
            <FaHeadset className="text-[#5E9FE9] text-xl md:text-3xl" />
          </div>
      ...
      {/* Canaux de contact */}
      <section className="mx-auto max-w-6xl px-4 pt-8 md:pt-16 pb-8 md:pb-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          <article className="group rounded-2xl border border-gray-200 bg-white p-4 md:p-7 shadow-xl hover:bg-gray-50 transition-all duration-300">
            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#5E9FE9]/10">
              <FaEnvelope className="text-[#5E9FE9] text-lg md:text-2xl" />
            </div>
            <h2 className="text-base md:text-xl font-semibold">{isFr ? tr.emailTitleFr : tr.emailTitleEn}</h2>
          ...
          <article className="group rounded-2xl border border-gray-200 bg-white p-4 md:p-7 shadow-xl hover:bg-gray-50 transition-all duration-300">
            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#5E9FE9]/10">
              <FaClock className="text-[#5E9FE9] text-lg md:text-2xl" />
            </div>
            <h2 className="text-base md:text-xl font-semibold">{isFr ? tr.hoursTitleFr : tr.hoursTitleEn}</h2>
          ...
          <article className="group rounded-2xl border border-gray-200 bg-white p-4 md:p-7 shadow-xl hover:bg-gray-50 transition-all duration-300">
            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-red-50">
              <FaTriangleExclamation className="text-red-600 text-lg md:text-2xl" />
            </div>
            <h2 className="text-base md:text-xl font-semibold">{isFr ? tr.emergencyTitleFr : tr.emergencyTitleEn}</h2>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-12 md:pb-16">
        <div className="rounded-2xl border border-gray-200 bg-gray-50 p-6 md:p-10 shadow-xl">
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-center mb-6 md:mb-10">
      ...
      <section className="mx-auto max-w-5xl px-4 pb-20">
        <div className="rounded-2xl border border-gray-200 bg-gray-50 p-6 md:p-10 shadow-xl text-center">
          <FaShieldHalved className="mx-auto text-2xl md:text-4xl text-[#5E9FE9] mb-4" />
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4">{isFr ? tr.ctaReportTitleFr : tr.ctaReportTitleEn}</h2>
          <p className="text-gray-500 mb-8 max-w-lg mx-auto">{isFr ? tr.ctaReportDescFr : tr.ctaReportDescEn}</p>
          <Link href="/securite#signalement-form" className="inline-flex items-center gap-2 rounded-xl bg-[#5E9FE9] px-6 md:px-8 py-3 text-sm md:text-base font-semibold text-white hover:bg-[#4a8fd4] transition-colors shadow-lg shadow-[#5E9FE9]/25">
