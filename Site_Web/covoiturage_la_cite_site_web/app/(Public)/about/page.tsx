  ...
  return (
    <main className="min-h-screen bg-white text-gray-900 w-full">
      ...
      <section className="relative overflow-hidden w-full">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pt-16 md:pt-28 pb-12 md:pb-36 text-center w-full">
          <div className="mx-auto mb-6 flex h-16 w-16 md:h-20 md:w-20 items-center justify-center rounded-full bg-[#5E9FE9]/10 border border-[#5E9FE9]/20 shadow-md">
            <FaGraduationCap className="text-[#5E9FE9] text-base lg:text-3xl" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 w-full">
          <article className="group rounded-2xl border border-gray-200 bg-white p-4 md:p-7 shadow-xl hover:bg-gray-50 transition-all duration-300 w-full">
            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#5E9FE9]/10">
              <FaRoad className="text-[#5E9FE9] text-base lg:text-2xl" />
            </div>
            <h3 className="text-sm lg:text-xl font-semibold">{isFr ? tr.missionTitleFr : tr.missionTitleEn}</h3>
          ...
          <article className="group rounded-2xl border border-gray-200 bg-white p-4 md:p-7 shadow-xl hover:bg-gray-50 transition-all duration-300 w-full">
            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#5E9FE9]/10">
              <FaUsers className="text-[#5E9FE9] text-base lg:text-2xl" />
            </div>
            <h3 className="text-lg md:text-xl font-semibold">{isFr ? tr.communityTitleFr : tr.communityTitleEn}</h3>
          ...
          <article className="group rounded-2xl border border-gray-200 bg-white p-4 md:p-7 shadow-xl hover:bg-gray-50 transition-all duration-300">
            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#5E9FE9]/10">
              <FaLeaf className="text-[#5E9FE9] text-lg md:text-2xl" />
            </div>
            <h3 className="text-lg md:text-xl font-semibold">{isFr ? tr.impactTitleFr : tr.impactTitleEn}</h3>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-12 md:pb-16">
        <div className="rounded-2xl border border-gray-200 bg-gray-50 p-6 md:p-10 shadow-xl">
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-center mb-8 md:mb-10">
            <FaChartLine className="inline mr-2 text-[#5E9FE9]" />
            {isFr ? tr.statsTitleFr : tr.statsTitleEn}
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 text-center">
            <div>
              <div className="text-2xl md:text-4xl font-bold text-[#5E9FE9]">{formatUsers(stats.totalUsers)}</div>
              <p className="mt-2 text-sm text-gray-500">{isFr ? tr.statsMembersFr : tr.statsMembersEn}</p>
            </div>
            <div>
              <div className="text-2xl md:text-4xl font-bold text-[#5E9FE9]">{formatTrips(stats.totalTrips)}</div>
              <p className="mt-2 text-sm text-gray-500">{isFr ? tr.statsTripsFr : tr.statsTripsEn}</p>
            </div>
            <div>
              <div className="text-2xl md:text-4xl font-bold text-[#5E9FE9]">{formatCo2(stats.totalCo2SavedKg)}</div>
              <p className="mt-2 text-sm text-gray-500">{isFr ? tr.statsCo2Fr : tr.statsCo2En}</p>
            </div>
            <div>
              <div className="text-2xl md:text-4xl font-bold text-[#5E9FE9]">4.8 / 5</div>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-12 md:pb-16">
        ...
        <div className="grid gap-4 md:gap-5 md:grid-cols-2">
          <div className="flex gap-5 rounded-2xl border border-gray-200 bg-white p-4 md:p-6 shadow-lg">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#5E9FE9]/10">
              <FaHandshake className="text-[#5E9FE9] text-lg md:text-xl" />
            </div>
            <div>
              <h3 className="font-semibold text-base md:text-lg">{isFr ? tr.valueTrustTitleFr : tr.valueTrustTitleEn}</h3>
              <p className="mt-2 text-gray-600 leading-7">{isFr ? tr.valueTrustDescFr : tr.valueTrustDescEn}</p>
            </div>
          </div>
          <div className="flex gap-5 rounded-2xl border border-gray-200 bg-white p-4 md:p-6 shadow-lg">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#5E9FE9]/10">
              <FaStar className="text-[#5E9FE9] text-lg md:text-xl" />
            </div>
            <div>
              <h3 className="font-semibold text-base md:text-lg">{isFr ? tr.valueExcellenceTitleFr : tr.valueExcellenceTitleEn}</h3>
              <p className="mt-2 text-gray-600 leading-7">{isFr ? tr.valueExcellenceDescFr : tr.valueExcellenceDescEn}</p>
            </div>
          </div>
          <div className="flex gap-5 rounded-2xl border border-gray-200 bg-white p-4 md:p-6 shadow-lg">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#5E9FE9]/10">
              <FaGlobe className="text-[#5E9FE9] text-lg md:text-xl" />
            </div>
            <div>
              <h3 className="font-semibold text-base md:text-lg">{isFr ? tr.valueResponsibilityTitleFr : tr.valueResponsibilityTitleEn}</h3>
              <p className="mt-2 text-gray-600 leading-7">{isFr ? tr.valueResponsibilityDescFr : tr.valueResponsibilityDescEn}</p>
            </div>
          </div>
          <div className="flex gap-5 rounded-2xl border border-gray-200 bg-white p-4 md:p-6 shadow-lg">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#5E9FE9]/10">
              <FaCar className="text-[#5E9FE9] text-lg md:text-xl" />
            </div>
            <div>
              <h3 className="font-semibold text-base md:text-lg">{isFr ? tr.valueAccessibilityTitleFr : tr.valueAccessibilityTitleEn}</h3>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16 md:pb-20">
        <div className="rounded-2xl border border-gray-200 bg-gray-50 p-6 md:p-10 shadow-xl">
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-center mb-3 md:mb-10">
            <FaShieldHalved className="inline mr-2 text-[#5E9FE9]" />
            {isFr ? tr.securityTitleFr : tr.securityTitleEn}
          </h2>
          <p className="text-center text-gray-500 mb-8 md:mb-10 max-w-2xl mx-auto">
            {isFr ? tr.securitySubtitleFr : tr.securitySubtitleEn}
          </p>
          <div className="grid gap-4 md:gap-6 md:grid-cols-3">
            <article className="rounded-xl border border-gray-200 bg-white p-4 md:p-6 hover:bg-gray-50 transition-all duration-300">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#5E9FE9]/10">
                <FaUserCheck className="text-[#5E9FE9] text-lg md:text-xl" />
              </div>
              <h3 className="font-semibold text-base md:text-lg">{isFr ? tr.securityVerifyTitleFr : tr.securityVerifyTitleEn}</h3>
              <p className="mt-3 text-sm text-gray-500 leading-6">{isFr ? tr.securityVerifyDescFr : tr.securityVerifyDescEn}</p>
            </article>
            <article className="rounded-xl border border-gray-200 bg-white p-4 md:p-6 hover:bg-gray-50 transition-all duration-300">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#5E9FE9]/10">
                <FaTriangleExclamation className="text-[#5E9FE9] text-lg md:text-xl" />
              </div>
              <h3 className="font-semibold text-base md:text-lg">{isFr ? tr.securityReportTitleFr : tr.securityReportTitleEn}</h3>
              <p className="mt-3 text-sm text-gray-500 leading-6">{isFr ? tr.securityReportDescFr : tr.securityReportDescEn}</p>
            </article>
            <article className="rounded-xl border border-gray-200 bg-white p-4 md:p-6 hover:bg-gray-50 transition-all duration-300">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#5E9FE9]/10">
                <FaLock className="text-[#5E9FE9] text-lg md:text-xl" />
              </div>
              <h3 className="font-semibold text-base md:text-lg">{isFr ? tr.securitySessionTitleFr : tr.securitySessionTitleEn}</h3>
