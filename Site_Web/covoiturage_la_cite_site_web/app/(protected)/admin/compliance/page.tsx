        ...
        <>
          <section className="compliance-overview">
            ...
            <div className="compliance-card">
              ...
              <p className="value">{status.anonimizationRequests}</p>
            </div>
            <div className="compliance-card">
              <h3>Dernier Audit</h3>
              <p className="value">
          ...
          <tbody>
            {exports.map((exp) => (
              <tr key={exp.userId}>
                ...
                <td>{new Date(exp.expiresAt).toLocaleDateString()}</td>
                <td>
                  {exp.status === "Pending" && (
                    <button
                      onClick={() => handleProcessExport(exp.userId)}
